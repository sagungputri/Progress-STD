...
void menu(){
	...
	cout<<(" | 3.Cari Detail Toko                  |")<<endl;
	cout<<(" | 4.Cari Detail Produk                |")<<endl;
	cout<<(" | 5.Cari Detail Produk di suatu Toko  |")<<endl;
	cout<<(" | 6.Hapus Toko                        |")<<endl;
	cout<<(" | 7.Hapus Produk                      |")<<endl;
	cout<<(" | 8.Hapus Produk di suatu  Toko       |")<<endl;
	cout<<(" | 9.Tampil List Toko                  |")<<endl;
	cout<<(" | 10.Tampil List Produk               |")<<endl;
	cout<<(" | 11.Tampil List Toko & Produk        |")<<endl;
	cout<<(" | 12.Jumlah Produk di Toko            |")<<endl;
	cout<<(" =======================================")<<endl;
	cout<<("")<<endl;
